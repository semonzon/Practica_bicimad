# -*- coding: utf-8 -*-
"""
Created on Thu May 25 21:14:55 2023
...
#donde A es la estación principal, L son sus conexiones y X son los elementos de la forma (B,'origen'/'destino'), 
...
def main():
    ...
    for filename in os.listdir(files):
      ...
      if filename.endswith('.json') and filename[:6] == '201801':
        ...
        columnas_conexiones = ["Estación","Numero_Conexiones","Mes"]
    ...
    rdd_conexiones = rdd_conexiones.\
                     ...
                     groupByKey().\
                     mapValues(list).\
                     mapValues(lambda x: round(mean(x))).\
                     sortBy(lambda x: x[1], ascending = False)
    ...
    columnas_conexiones = ["Estación","Numero_conexiones"]
    rdd_conexiones2 = rdd_conexiones.toDF(columnas_conexiones)
    ...
    rdd_tiempo2 = rdd_tiempo.toDF(columnas_tiempo)
    print('\n')
